...
<br>
       <div class="container">
		...
		<h1 class="text-white bg-dark text-center">ADD DEPARTMENT</h1>
...
<div class="container">
    <div class="col-lg-12">
        <h1 class="text-warning text-center">MANAGE DEPARTMENT</h1>
            <br>
    ...
    ?>
        ...
        <tr class="text-center">
          ...
          <td> <button class="btn-danger btn"> <a href="deletedepartment.php?id=<?php echo $res['id']; ?>" class="text-white">Delete</a></button></td>
